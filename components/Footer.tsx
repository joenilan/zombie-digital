...
export function Footer() {
    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            timeoutId = setTimeout(checkScroll, 50) // 50ms debounce
        }
    ...
    // Add padding so footer doesn't cover content
    useEffect(() => {
        document.body.style.paddingBottom = showExpanded ? '200px' : '60px'
        return () => {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="bg-background/95 backdrop-blur-xl border-t border-white/5 px-6 py-3"
                initial={{ opacity: 0.9 }}
                animate={{ opacity: showExpanded ? 1 : 0.9 }}
            ...
            {/* Expanded content that appears when near bottom */}
            <AnimatePresence>
                {showExpanded && (
                    <motion.div
                        className="bg-background/90 backdrop-blur-xl border-t border-white/10 px-6 py-6"
                        initial={{
                            opacity: 0,
                            height: 0
                        }}
